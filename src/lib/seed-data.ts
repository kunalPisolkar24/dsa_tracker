...
export const seedTopics: TopicStoreItem[] = [
  {
    ...
    subtopics: [
      {
        ...
        problems: [
          { id: "sp-ps-1", title: "Range Sum Query - Immutable", url: "https://leetcode.com/problems/range-sum-query-immutable/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
          { id: "sp-ps-2", title: "Contiguous Array", url: "https://leetcode.com/problems/contiguous-array/", difficulty: "MEDIUM", status: "SOLVED", reviewCount: 0 },
      ...
      },
      {
        ...
        problems: [
          { id: "sp-sw-1", title: "Maximum Average Subarray I", url: "https://leetcode.com/problems/maximum-average-subarray-i/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
          { id: "sp-sw-2", title: "Longest Substring Without Repeating Characters", url: "https://leetcode.com/problems/longest-substring-without-repeating-characters/", difficulty: "MEDIUM", status: "SOLVED", reviewCount: 0 },
    ...
    problems: [
      { id: "sp-d-1", title: "Two Sum", url: "https://leetcode.com/problems/two-sum/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
      { id: "sp-d-2", title: "Contains Duplicate", url: "https://leetcode.com/problems/contains-duplicate/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
      { id: "sp-d-3", title: "Valid Anagram", url: "https://leetcode.com/problems/valid-anagram/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
  ...
  },
  {
    ...
    subtopics: [
      {
        ...
        problems: [
          { id: "sp-tp-int-1", title: "Merge Intervals", url: "https://leetcode.com/problems/merge-intervals/", difficulty: "MEDIUM", status: "SOLVED", reviewCount: 0 },
          { id: "sp-tp-int-2", title: "Insert Interval", url: "https://leetcode.com/problems/insert-interval/", difficulty: "MEDIUM", status: "SOLVED", reviewCount: 0 },
      ...
      },
      {
        ...
        problems: [
          { id: "sp-tp-fs-1", title: "Linked List Cycle", url: "https://leetcode.com/problems/linked-list-cycle/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
    ...
    problems: [
      ...
      { id: "sp-tp-d-4", title: "Valid Palindrome", url: "https://leetcode.com/problems/valid-palindrome/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
      { id: "sp-tp-d-5", title: "Two Sum II - Input Array Is Sorted", url: "https://leetcode.com/problems/two-sum-ii-input-array-is-sorted/", difficulty: "MEDIUM", status: "SOLVED", reviewCount: 0 },
    ],
  },
  {
    id: "seed-stack-queue",
    ...
    subtopics: [
      {
        ...
        problems: [
          { id: "sp-sq-ms-1", title: "Daily Temperatures", url: "https://leetcode.com/problems/daily-temperatures/", difficulty: "MEDIUM", status: "SOLVED", reviewCount: 0 },
          { id: "sp-sq-ms-2", title: "Next Greater Element I", url: "https://leetcode.com/problems/next-greater-element-i/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
    ...
    problems: [
      { id: "sp-sq-d-1", title: "Valid Parentheses", url: "https://leetcode.com/problems/valid-parentheses/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
      { id: "sp-sq-d-2", title: "Min Stack", url: "https://leetcode.com/problems/min-stack/", difficulty: "MEDIUM", status: "SOLVED", reviewCount: 0 },
    ...
    subtopics: [
      {
        ...
        problems: [
          { id: "sp-ll-rv-1", title: "Reverse Linked List", url: "https://leetcode.com/problems/reverse-linked-list/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
          { id: "sp-ll-rv-2", title: "Reverse Linked List II", url: "https://leetcode.com/problems/reverse-linked-list-ii/", difficulty: "MEDIUM", status: "SOLVED", reviewCount: 0 },
      ...
      },
      {
        ...
        problems: [
          { id: "sp-ll-fl-1", title: "Middle of the Linked List", url: "https://leetcode.com/problems/middle-of-the-linked-list/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
          ...
          { id: "sp-ll-fl-3", title: "Intersection of Two Linked Lists", url: "https://leetcode.com/problems/intersection-of-two-linked-lists/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
        ],
      },
    ],
    problems: [
      { id: "sp-ll-d-1", title: "Merge Two Sorted Lists", url: "https://leetcode.com/problems/merge-two-sorted-lists/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
      { id: "sp-ll-d-2", title: "Add Two Numbers", url: "https://leetcode.com/problems/add-two-numbers/", difficulty: "MEDIUM", status: "SOLVED", reviewCount: 0 },
  ...
  },
  {
    ...
    subtopics: [
      {
        ...
        problems: [
          { id: "sp-tr-bst-1", title: "Validate Binary Search Tree", url: "https://leetcode.com/problems/validate-binary-search-tree/", difficulty: "MEDIUM", status: "SOLVED", reviewCount: 0 },
          { id: "sp-tr-bst-2", title: "Lowest Common Ancestor of a BST", url: "https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/", difficulty: "MEDIUM", status: "SOLVED", reviewCount: 0 },
      ...
      },
      {
        ...
        problems: [
          { id: "sp-tr-tv-1", title: "Binary Tree Inorder Traversal", url: "https://leetcode.com/problems/binary-tree-inorder-traversal/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
          { id: "sp-tr-tv-2", title: "Binary Tree Level Order Traversal", url: "https://leetcode.com/problems/binary-tree-level-order-traversal/", difficulty: "MEDIUM", status: "SOLVED", reviewCount: 0 },
      ...
      },
      {
        ...
        problems: [
          { id: "sp-tr-bd-1", title: "Maximum Depth of Binary Tree", url: "https://leetcode.com/problems/maximum-depth-of-binary-tree/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
          { id: "sp-tr-bd-2", title: "Diameter of Binary Tree", url: "https://leetcode.com/problems/diameter-of-binary-tree/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
    ...
    problems: [
      { id: "sp-tr-d-1", title: "Invert Binary Tree", url: "https://leetcode.com/problems/invert-binary-tree/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
      { id: "sp-tr-d-2", title: "Same Tree", url: "https://leetcode.com/problems/same-tree/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
  ...
  },
  {
    ...
    subtopics: [
      {
        ...
        problems: [
          { id: "sp-dp-1d-1", title: "Climbing Stairs", url: "https://leetcode.com/problems/climbing-stairs/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
          { id: "sp-dp-1d-2", title: "House Robber", url: "https://leetcode.com/problems/house-robber/", difficulty: "MEDIUM", status: "SOLVED", reviewCount: 0 },
      ...
      },
      {
        ...
        problems: [
          { id: "sp-dp-kp-1", title: "Partition Equal Subset Sum", url: "https://leetcode.com/problems/partition-equal-subset-sum/", difficulty: "MEDIUM", status: "SOLVED", reviewCount: 0 },
      ...
      },
      {
        ...
        problems: [
          { id: "sp-dp-lcs-1", title: "Longest Common Subsequence", url: "https://leetcode.com/problems/longest-common-subsequence/", difficulty: "MEDIUM", status: "SOLVED", reviewCount: 0 },
    ...
    problems: [
      { id: "sp-dp-d-1", title: "Fibonacci Number", url: "https://leetcode.com/problems/fibonacci-number/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
      { id: "sp-dp-d-2", title: "Best Time to Buy and Sell Stock", url: "https://leetcode.com/problems/best-time-to-buy-and-sell-stock/", difficulty: "EASY", status: "SOLVED", reviewCount: 0 },
